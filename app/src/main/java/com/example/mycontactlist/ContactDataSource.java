...
public class ContactDataSource {
    ...
    public ArrayList<String> getContactName() {
        ...
        try {
            //The SQL query is written to return the contactname field for all records in the contact table and then executed in Line 5. The cursor object holds the results of the query
